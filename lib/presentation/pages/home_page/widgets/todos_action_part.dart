                  ...
                  child: SizedBox(
                    ...
                    child: customNumericTextField(
                              'Haber', 'Ingrese el haber', 10, controller: haberC,
                               onChanged: (text) {
                                ref.read(todoNotifierProvider.notifier).mapEventsToState(TodoHaberChanged(text: haberC.value.text),);
                              }, 
                            ),
                  ),
                ),
          ...
          children: [
            SizedBox(
              ...
              child: TextField(
                ...
                autocorrect: false,
                onChanged: (text) {
                  ref.read(todoNotifierProvider.notifier).mapEventsToState(TodoTitleChanged(text: textfieldController.value.text),);
                },
              ),
            ),
            IconButton(
